...
public class RadioGridGroup extends LinearLayout {
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new RadioGridGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof RadioGridGroup.LayoutParams;
    }
